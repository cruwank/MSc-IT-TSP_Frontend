                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex space-x-[5%] w-full">
                                            <FormField control={form.control} name="date" render={({ field }) => (
                                                <FormItem className="w-[60%]">
                                                    <FormControl>
                                                        <Input type="date" placeholder="date" {...field} className="border rounded-md p-2  " />
                                                    </FormControl>
                                                </FormItem>
                                            )} />
                                            <FormField control={form.control} name="fromTime" render={({ field }) => (
                                                <FormItem className="w-[40%]">
                                                    <FormControl>
                                                        <Input placeholder="From Time" {...field} className="border rounded-md p-2 " />
                                                    </FormControl>
                                                </FormItem>
                                            )} />
                                            <FormField control={form.control} name="toTime" render={({ field }) => (
                                                <FormItem className="w-[40%]">
                                                    <FormControl>
                                                        <Input placeholder="To Time" {...field} className="border rounded-md p-2 " />
                                                    </FormControl>
                                                </FormItem>
                                            )} />
